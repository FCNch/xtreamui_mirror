...
* rm install.py; wget https://github.com/FCNch/xtreamui_mirror/raw/master/withmariadb/install.py;
...
* git clone https://github.com/FCNch/xtreamui-things.git /tmp/xtreamui-things  
